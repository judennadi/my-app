...
class Projects extends Component {
  ...
  state = {
    projects: [
      { id: 1, image: project1, nick: "WENDI&J", handle: "wendi&j" },
      { id: 2, image: project1, nick: "WENDI&J", handle: "wendi&j" },
      { id: 3, image: project1, nick: "WENDI&J", handle: "wendi&j" },
      { id: 4, image: project1, nick: "WENDI&J", handle: "wendi&j" },
      { id: 6, image: project1, nick: "WENDI&J", handle: "wendi&j" },
      { id: 7, image: project1, nick: "WENDI&J", handle: "wendi&j" },
    ],
    scrolled: false,
  };
  handleScroll = () => {
  ...
  render() {
    return (
      <>
        <section className="section" id="projects" ref={this.myRef}>
          <div
            className={
              this.state.scrolled
          ...
          <div className="help-sticky">
            {this.state.projects.map((project) => {
              const { id, image, nick, handle } = project;
              return (
